...
if __name__ == '__main__':
    ...
    while not rospy.is_shutdown():
        ...
        ax1.plot(y_plan7[1,:],y_plan7[2,:],'--')
        ax1.plot(y_plan8[1,:],y_plan8[2,:],'--')
        ax1.plot(y_plan9[1,:],y_plan9[2,:],'--')
        ax1.plot(y_plan10[1,:],y_plan10[2,:],'--')
        ax1.plot(y_plan11[1,:],y_plan11[2,:],'--')
        ax1.plot(curpose.pose[1],curpose.pose[2],'og',label = 'user')
        ax1.plot(desirpos.pose[1]/1000,desirpos.pose[2]/1000,'or',label = 'DMP')
        #ax1.plot(willdesirpos.pose[1]/1000,willdesirpos.pose[2]/1000,'ob',label = 'will DMP')
        ax1.plot(ExecutedTraj[1:,1],ExecutedTraj[1:,2],'k',label = 'executed traj')
        ...
        ax2.plot(ExecutedCredit[1:,3],'-', label = 'traj 4')
        #ax2.plot(ExecutedCredit[1:,4],'b--', label = 'max') # max
