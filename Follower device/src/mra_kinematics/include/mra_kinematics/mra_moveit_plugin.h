#ifndef MRA_KINEMATICS_PLUGIN_
#define MRA_KINEMATICS_PLUGIN_
...
*/
  class MRAKinematicsPlugin : public kinematics::KinematicsBase
  {
    public:
...
*/
    MRAKinematicsPlugin();
	//重写的是第一个getPositionIK，因为在父类kinematicsBase里有两个getPositionIK方法但只有第一个是纯虚函数，需要重写
...
*/
    ...
    // MRA base link, and the MRA tip link to the group tip link
